...
//        themeVariants.put("Blueprint", "Blueprint");
//        themeVariants.put("Dark", "Dark");
//        themeVariants.put("Facebook", "Facebook");
//        themeVariants.put("FlatDark", "Flat dark");
//        themeVariants.put("Flat", "Flat");
//        themeVariants.put("Light", "Light");
//        themeVariants.put("Metro", "Metro");
//        themeVariants.put("Reindeer", "Migrate Reindeer");
//    }
