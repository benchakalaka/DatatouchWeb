...
public class AreaViewUiHelper {
    public static void initAreasGrid(Grid<AreaGridItem> grid, String areaFilesUrl, IAreaSelectedCallback callback) {
...
//                .setExpandRatio(4);
        ...
        grid.addSelectionListener((selectionEvent ->  {
            if (selectionEvent.getFirstSelectedItem().isPresent())
                callback.areaSelected(selectionEvent.getFirstSelectedItem().get());
        }));
