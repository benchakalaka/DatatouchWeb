...
public class CreateAreaFromPdfRequest extends SuperRequestView {
    ...
    public CreateAreaFromPdfRequest(int siteId, String fileName, String areaName, byte[] fileData) {
